...
// in simulator we redefine to format for BabyCalender Developer console
...
{\
	NSString * exceptionName = [@"org.babycalender." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.babycalender";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIBabyCalenderNativeItemNone = -1, 
	UIBabyCalenderNativeItemSpinner = -2,
	UIBabyCalenderNativeItemProgressBar = -3,
	
	UIBabyCalenderNativeItemSlider = -4,
	UIBabyCalenderNativeItemSwitch = -5,
	UIBabyCalenderNativeItemMultiButton = -6,
	UIBabyCalenderNativeItemSegmented = -7,
	
	UIBabyCalenderNativeItemTextView = -8,
	UIBabyCalenderNativeItemTextField = -9,
	UIBabyCalenderNativeItemSearchBar = -10,
	
	UIBabyCalenderNativeItemPicker = -11,
	UIBabyCalenderNativeItemDatePicker = -12,
	
	UIBabyCalenderNativeItemInfoLight = -13,
	UIBabyCalenderNativeItemInfoDark = -14,
	
	UIBabyCalenderNativeItemDisclosure = -15,
	
	UIBabyCalenderNativeItemContactAdd = -16
};
