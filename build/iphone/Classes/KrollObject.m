...
//@interface BabyCalenderObject : NSObject
//@end

@interface BabyCalenderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BabyCalenderObject class]])
		{
			for (NSString *key in [[(BabyCalenderObject*)o modules] allKeys])
			{
